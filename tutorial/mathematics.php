...
<body>
    ...
    <h5 class="text-center bg-warning fw-bold">MATHEMATICS</h5>
    <div class="p-2 align-items-center d-flex" ><form><input class="form-control border-warning" type="text" placeholder="search"></form> <i class="fas fa-search"></i> </div>
	<div class="row	mx-0">
		<div class="col-lg-3">
			<div class="pb-2 m-4">
