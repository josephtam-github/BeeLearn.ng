...
<body>
	...
	<div id="eToggleObject1" class="shadow-sm d-md-none container-fuid">
		<a class="text-center text-decoration-none text-reset fw-bold border-bottom border-2 font-roboto border-dark py-2 nav-link p-1 bg-warning animate-left-2  border-top" href="./news.php">NEWS</a>
	...
	<div class="container-fluid h-25 bg-danger p-5 m">
	advertisementbanner 
	</div>

	<div class="row mx-0 my-2 justify-content-center text-decoration-none p-1">
		<div class="col-lg-5">
			<div class="shadow-sm pb-2">
				<h4 class="text-dark text-center bg-warning-light-hover">TRENDING NEWS</h4>
				<a href='./news/waec-releases-2021-result-for-school-candidates.php' class='text-decoration-none'>
					<div class="card p-3 m-2 font-montserrat" >
						<img src="./images/WBD.jpg" alt="world book day" class="card-body card-img d-block  w-100">
				...
				<a href="#">
					<div class="card p-3 m-2 font-montserrat" >
						<p class="card-title">The students of uniport celebrate their matric</p>
						<small class="card-text text-muted"><i class="fas fa-clock"></i> 1 minute ago</small>
					</div>
				</a>
				<a href="#">
					<div class="card p-3 m-2 font-montserrat" >
						<p class="card-title">A studdent from ben idahosa university graduatews with 5.0</p>
						<small class="card-text text-muted"><i class="fas fa-clock"></i> 1 minute ago</small>
					</div>
				</a>
			</div>
		...
		<div class="col-lg-5">
			<div class="shadow-sm pb-2">
				<h4 class="text-light text-center bg-primary-dark-hover">UNIVERSITY STREAM</h4>
				<div class="card p-3 m-2 font-montserrat" >
					<p class="card-title ">Students plan protest as uniport forces 5 months holiday</p>
					<small class="card-text text-muted"><i class="fas fa-clock"></i> 1 minute ago</small>
				</div>
				<div class="card p-3 m-2 font-montserrat" >
					<p class="card-title">The students of uniport celebrate their matric</p>
				...
				<div class="card p-3 m-2 font-montserrat" >
					<p class="card-title">School shooting in UNILAG but no one was harmed</p>
					<small class="card-text text-muted"><i class="fas fa-clock"></i> 1 minute ago</small>
				</div>
				<div class="card p-3 m-2 font-montserrat" >
					<p class="card-title">The students of uniport celebrate their matric</p>
	...
	<div class="row mx-0 my-2 justify-content-center text-decoration-none p-1">
		<div class="col-lg-10">
			<div class="shadow-sm pb-2">
				<h4 class="text-dark text-center bg-warning-light-hover">RECENT HEADLINES</h4>
				<a href="" class="text-decoration-none">
					<div class="card m-2 font-montserrat" >
						<div class="row align-items-center">
							<div class="d-none d-md-block col-md-2 rh-2 px-2">
								<img src="./images/WBD.jpg" alt="world book day" id="lg-crop" class="small-thumbnail card-body d-block card-img w-100">
							</div>
							<div class="col-10">
								<h4 class="card-title fw-bold rh-1 px-2 pt-2 p-md-none">Students plan protest as uniport forces 5 months holiday</h4>
								<p class="card-text text-truncate rh-1 px-2 p-md-none">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aspernatur facilis, vitae debitis itaque recusandae unde maiores quibusdam mollitia cumque, officia ut eius, rem magnam. Eaque, laboriosam tenetur? Fugiat, distinctio ratione. </p>
								<small class="card-text text-muted rh-1 px-2 p-md-none"><i class="fas fa-clock"></i> 1 minute ago</small>
							</div>
						</div>
					</div>
				</a>
