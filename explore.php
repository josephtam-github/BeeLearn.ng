...
<head>
	...
	<title>Explore | BeeLearn.ng</title>
	<meta charset="UTF-8">
...
<body>
	...
	<!-- background animation from https://bgjar.com -->
	<div class="text-center cheese-bg align-item-center justify-content-center p-5">
		<div class="p-2">
			<figure class="text-center">
				<blockquote class="blockquote">
					<h1 class="fw-bolder">Fortune favors the bold</h1>
				</blockquote>
				<figcaption><cite>- Vrigil</cite></figcaption>
			</figure>
		</div>
	</div>
	...
	<div class="floatingshapes-bg">
		<div class="row	mx-0">
			...
			<a href="./campus.php" class="text-decoration-none">
				<div class="m-5">
					<h4 class="text-dark text-center bg-warning warning-hover p-0 my-0">CAMPUS HIVE</h4>
		...
		<div class="row	mx-0">
			<div class="col-lg-8">
				<a href="./forum.php" class="text-decoration-none">
					<div class="m-5">
						<h4 class="text-light text-center bg-primary-dark-hover p-0 my-0">EDU-FORUM</h4>
						<div class="card p-3 font-montserrat" >
							<img src="./images/WBD.jpg" alt="world book day" id="lg-crop" class="card-body card-img d-block  w-100 h-md-100">
							<p class="card-title ">The West African Examination Council (WAEC) has released its 2020/2021 examination result</p>
						</div>
		...
		<div class="row	mx-0">
			<div class="col-lg-8">
				<div class="m-5">
					<h4 class="text-dark text-center bg-warning-light-hover p-0 my-0">QUIZ-BEE</h4>
					<div class="card p-3 font-montserrat" >
						<img src="./images/WBD.jpg" alt="world book day" id="lg-crop" class="card-body card-img d-block  w-100 h-md-100">
						<p class="card-title ">The West African Examination Council (WAEC) has released its 2020/2021 examination result</p>
					</div>
		...
		<div class="row	mx-0">
			<div class="col-lg-8">
				<div class="m-5">
					<h4 class="text-light text-center bg-primary-dark-hover p-0 my-0">SCHOLARSHIPS</h4>
					<div class="card p-3 font-montserrat" >
						<img src="./images/WBD.jpg" alt="world book day" id="lg-crop" class="card-body card-img d-block  w-100 h-md-100">
						<p class="card-title ">The West African Examination Council (WAEC) has released its 2020/2021 examination result</p>
					</div>
