...
<body>
	...
	<div class="text-center cheese-bg align-item-center justify-content-center p-5">
		<div class="p-2">
			<figure class="text-center">
				<blockquote class="blockquote">
					<h1 class="fw-bolder">Learners are leaders</h1>
				</blockquote>
    ...
    <h5 class="text-center bg-warning fw-bold">LATEST VIDEOS</h5>
	<div class="row	mx-0">
		<div class="col-lg-3">
			<div class="pb-2 m-4">
                ...
                <h5 class="text-light text-center bg-primary-dark-hover p-0 my-0">WAEC BROCHURE</h5>
			</div>
		</div>
		<div class="col-lg-3">
			<div class="pb-2 m-4">
                ...
                <h5 class="text-dark text-center bg-warning-light-hover p-0 my-0">JAMB SYLLABUS</h5>
			</div>
		</div>
		<div class="col-lg-3">
			<div class="pb-2 m-4">
	...
	<table class="table table-bordered fw-bold text-center justify-content-center border-warning">
		<thead>
		...
		<tr>
			<td>
				<a href="./tutorial/biology">BIOLOGY</a>
			</td>
			<td>
				<a href="./tutorial/christian-religious-study.php">CHRISTIAN STUDY</a>
			</td>
			<td>
				<a href="./tutorial/commerce.php">COMMERCE</a>
			</td>
		</tr>
		<tr>
			<td>
				<a href="./tutorial/computer-science.php">COMPUTER SCIENCE</a>
			</td>
			<td>
				<a href="./tutorial/english.php">ENGLISH</a>
			</td>
			<td>
				<a href="./tutorial/further-mathematics.php">FUTHER MATHEMATICS</a>
			</td>
		</tr>
		<tr>
			<td>
				<a href="./tutorial/government.php">GOVERNMENT</a>
			</td>
			<td>
				<a href="./tutorial/literature.php">LITERATURE</a>
			</td>
			<td>
				<a href="./tutorial/MATHEMATICS.php"> MATHEMATICS</a>
			</td>
		</tr>
		<tr>
			<td>
				<a href="./tutorial/physics.php">PHYSICS</a>
			</td>
			<td>
				<a href="./tutorial/technical-drawing.php">TECHNICAL DRAWING</a>
			</td>
			<td>
				<a href="./tutorial/geography.php">GEOGRAPHY</a>
			</td>
		</tr>
	</table>
