...
<div class="shadow-sm container-fluid p-0">
	...
	<div class="row mx-0 bg-dark"> 
		...
		<div class="col-lg-9 col-md-6 text-white">
    		<p class="text-center fw-bold fs-2 font-montserrat mt-5"> Weclome <?php echo $_SESSION["username"];?> let's get impart knowledge! </p>
                <div class="mx-0 my-5">
                    ...
                    <div class="m-5">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
                            <div class="form-group my-5">
                              ...
                              <input type="text" name="title" class="form-control no-shadow" required placeholder="e.g Partial Fractions"></input>
                            </div>

                            <div class="form-group my-5">
                              <label class="lead fs-3">Link</label>
                              <input type="text" name="link" class="form-control no-shadow" required placeholder="e.g https://www.youtube.com/watch?v=sdBJ2xNnd1y"></input>
                            </div>

                            <div class="form-group my-5">
                              <label class="lead fs-3">Author</label>
                              <input type="text" name="author" class="form-control no-shadow" required placeholder="e.g Chinma Udeji"></input>
                            </div>
							...
							<div class="form-group my-5">
								  <label class="form-label lead fs-3">Tag</label>
								  <select name="tag" class="form-select">
									<option value="biology" selected>BIOLOGY</option>
									<option value="christian-knowledge">CRS</option>
                            ...
                            <div class="form-group my-5">
                              ...
                              <textarea rows="80" cols="30" name="page-content" class="form-control no-shadow" required id="MirrorTextArea"><?php echo $tutorial_template;?></textarea>
                            </div>

                             <div class="form-group">
							 	<input type="hidden" name="directory" value="explore">
                                <button type="submit" name="preview-tutorial" class="btn btn-warning warning-hover fw-bold my-3 p-2 no-shadow"  id="preview-page">Preview</button>						
                             </div>
                        </form>
                    </div>
                </div>
	...
	<script src='../codemirror-5.65.2/addon/fold/foldgutter'></script>
	<script src='../codemirror-5.65.2/addon/fold/indent-fold.js'></script>
	<script src='../codemirror-5.65.2/addon/fold/foldcode.js'></script>
</body>
</html>
