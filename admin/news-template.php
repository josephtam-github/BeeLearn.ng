...
<div class="shadow-sm container-fluid p-0">
	...
	<div class="row mx-0 bg-dark"> 
		...
		<div class="col-lg-9 col-md-6 text-white">
    		<p class="text-center fw-bold fs-2 font-montserrat mt-5"> Weclome <?php echo $_SESSION["username"];?> let's get penactive! </p>
                <div class="mx-0 my-5">
                    ...
                    <div class="m-5">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
                            <div class="form-group my-5">
                              ...
                              <input type="text" name="title" class="form-control no-shadow" required placeholder="e.g WAEC 2020/2021 Result for School Candidates "></input>
                            </div>
                            ...
                            <div class="form-group my-5">
                             ...
                             <div class="form-group">
							 	<input type="hidden" name="directory" value="news">
