<?php
    ...
    $templatedb = new mysqli(DBHOST,DBUSER,DBPASS);
    $statement = "SELECT pageid FROM beelearn.pagedetail ORDER BY pageid DESC";
    $data = $templatedb->query($statement);
    if ($data) {
...
<body onload='loadComment();'>
    ...
    <div class='row mx-0'>
		<div class='col-lg-10 align-items-center justify-contents-center'>
			<div class='m-3'>
                <h2 class='text-center mt-4 font-montserrat'> PAGE HEADING HERE </h2>
        		...
        		<div class='bg-light border border-3 rounded-1 px-5 py-3'>
					<form method='POST' id='comment_form' onsubmit='submitForm(event)'>
						<div class='animate-zoom-10 form-group'>
							...
							<textarearegex rows='3' cols='20' name='comment' class='form-control' id='comment_id' required></textarearegex>
...
<body onload='loadComment();'>
	...
	<body>
		<div style='margin-left: auto; margin-right: auto; width:50%; margin-top: 100px; border-radius: 30px; background-color: rgb(255, 173, 1); padding: 30px; text-align: center;'>
			...
			<p style='font-weight: bold; text-align: justify;'>Thank you for signing up on our website. Write mail here</p>
			<div>
