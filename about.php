...
<body>
	...
	<div id="eToggleObject1" class="shadow-sm d-md-none container-fuid">
		<a class="text-center text-decoration-none text-reset fw-bold border-bottom border-2 font-roboto border-dark py-2 nav-link p-1 bg-warning animate-left-2 border-top" href="about.php">ABOUT&nbsp;US</a>
		...
		<a class="text-center text-decoration-none text-reset fw-bold border-bottom border-2 font-roboto border-dark py-2 nav-link p-1 bg-warning animate-left-12" href="download.php">DOWNLOAD</a>
		<?php 
			if (isset($_SESSION['id'])) {
	...
	<div>
		<img src="./images/aboutus_banner.svg" alt="About BeeLearn" class="d-block w-100">
	</div>

	<div class="bg-light mt-5 pb-5">
		<h4 class="bg-aqua bg-gradient text-light text-center py-2 fw-bolder">OUR VISION</h4>
		<p class="font-montserrat p-4 lh-lg">BeeLearn.ng was launched in late 2022 by Joseph Tam, with the aim and goal of encapsulating all educational resources, tools and materials in one platform and making it available to anyone, anywhere and on any device.
		 Not only do we strive to make these contents available but we are very particular as to how they are consumed. We make our contents effective and friendly by breaking it down to the most comprehensible form, adding the extra details and making it user-friendly for our learners.
		</p>
	</div>

	<div class="row mx-0 align-items-center">
		<div class="col-lg-6">
			<img src="./images/our_team.svg" alt="About BeeLearn" class="d-block w-100 p-1">
		</div>
		<div class="col-lg-6">
			<h2 class="font-montserrat p-5 text-center">We are a team dedicated to giving you the best.</h2>
		</div>
	</div>
		<div class="pb-5">
			<h4 class="bg-warning bg-gradient text-dark text-center py-2 fw-bolder">OUR STATS</h4>
			<!-- google website stats plus web stats -->
		</div>
	</div>
